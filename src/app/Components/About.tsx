        ...
        <Box style={styles.container}>
            <Box style={styles.textContainer}>
                <Typography style={styles.paragraph}>
                    ...
                    Here, you will find a selection of my current projects, each reflecting my desire to explore new technologies.
                ...
                <Typography style={styles.paragraph}>
                    ...
                    Another project currently in the works and coming soon is a project focusing on exploring artificial intelligence and OPENAIs APIs.
                    I aim to create an application to help teach languages. I hope to provide an interactive experience that enhances comprehension and engagement in an educational setting.
                </Typography>
