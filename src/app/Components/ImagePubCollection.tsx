...
const ImagePubCollection: React.FC = () => {
    const settings = {
        dots: true,
        infinite: true,
        speed: 500,
    ...
    return (
        <Box sx={{ maxWidth: '90vw', margin: '0 auto' }}>
            ...
            <div>
                    <img
                        src="/images/pub-crawl/cambridge.png"
                        alt="Wine Collection"
                ...
                <div>
                    <img
                        src="/images/pub-crawl/allNorwich.png"
                        alt="Dynamic Charts"
                        style={{ width: '100%', height: '50vh', objectFit: 'cover' }}
                    />
                </div>
                <div>
                    <img
                        src="/images/pub-crawl/allpubs.png"
                        alt="Wine Home"
                        style={{ width: '100%', height: '50vh', objectFit: 'cover' }}
                    />
                </div>
                <div>
                    <img
                        src="/images/pub-crawl/pubcrawl.png"
                        alt="With Charts"
                        style={{ width: '100%', height: '50vh', objectFit: 'cover' }}
                    />
                </div>
                <div>
                    <img
                        src="/images/pub-crawl/terrain.png"
                        alt="With Charts"
                        style={{ width: '100%', height: '50vh', objectFit: 'cover' }}
                    />
                </div>
...
export default ImagePubCollection;
